...
from model.wideresnet import SmallMetaConvNet, ResNet18
import datetime
from model.wideresnet import WideResNet, ResNet18, ResNet10, SmallMetaConvNet
...
for round in range(num_rounds):
    ...
    # torch.save(meta_net.state_dict(), f'/home/xm/code/meta_model/mlph_model_s_LN_hard_S{num_selected}_N{num_clients}_BS{batch_size}_{time_str}.pth')
    # torch.save(global_model.state_dict(), f'/home/xm/code/meta_model/global_model_s_LN_hard_S{num_selected}_N{num_clients}_BS{batch_size}_{time_str}.pth')
