...
for round in range(num_rounds):
    ...
    torch.save(meta_net.state_dict(), '/home/xm/code/meta_model/mlph_model_com0_LN1_hard.pth')
    torch.save(global_model.state_dict(), '/home/xm/code/meta_model/global_model_com0_LN1_hard.pth')
