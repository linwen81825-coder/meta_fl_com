...
for round in range(num_rounds):
    ...
    torch.save(meta_net.state_dict(), f'/home/xm/code/meta_model/mlph_model_com_LN_hard_{time_str}.pth')
    torch.save(global_model.state_dict(), f'/home/xm/code/meta_model/global_model_com_LN_hard_{time_str}.pth')
