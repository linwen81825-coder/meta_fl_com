...
for round in range(num_rounds):
    ...
    torch.save(meta_net.state_dict(), f'/home/xm/code/meta_model/mlph_model_s_COM_LN_hard_S{num_selected}_N{num_clients}_BS{batch_size}_{dataset}_{time_str}.pth')
    torch.save(global_model.state_dict(), f'/home/xm/code/meta_model/global_model_s_COM_LN_hard_S{num_selected}_N{num_clients}_BS{batch_size}_{dataset}_{time_str}.pth')
