...
def main():
    ...
    for r in range(num_rounds):
        ...
        name = "log_wideresnet_bandit_lr"+str(lr)+"_decay"+str(decay_factor)+"_alpha"+str(alpha)+"_C"+str(num_clients)+"_S"+str(num_selected)+"_Nbatch"+str(num_batch)+"_weighted"+str(weighted1)+"_DataSize"+str(ds)+"_CAlpha"+str(confident_alpha)+".mat"
