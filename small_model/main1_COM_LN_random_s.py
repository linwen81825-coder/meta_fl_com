...
for round in range(num_rounds):
    ...
    # 加权平均
    success_client = 0
    for grads, weight, isSuccess in zip(grads_list, pseudo_weight, client_com_prob_r_tensor_clip[0]):
    ...
    torch.save(global_model.state_dict(), f'/home/xm/code/meta_model/random_global_model_s_COM_LN_hard_S{num_selected}_N{num_clients}_BS{batch_size}_{time_str}.pth')
