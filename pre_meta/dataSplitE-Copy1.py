...
def data_split(num_clients, ratio=0.5, seed=23333, dataset='cifar'):
    ...
    print('global ratio per class: ', global_ratio_per_class)
...
def get_data_loaders(nclients, batch_size, real_wd=True, ratio=1, isnoise=False, weighted=False, dataset='cifar', seed=23333, classes_pc=10, verbose=True):
    ...
    if isnoise:
        ...
        clients_split, noise_ratio_lst = generate_noisy_data(y_train, clients_split) # [TODO] remember I return noise_ratio_lst here
        ...
        #c lient_loaders = [torch.utils.data.DataLoader(CustomImageDataset(x, y, transforms_train),
