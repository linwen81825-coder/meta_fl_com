...
for round in range(num_rounds):
    ...
    torch.save(global_model.state_dict(), f'/home/xm/code/meta_model/random_global_model_SMC_LN_hard_S{num_selected}_N{num_clients}_BS{batch_size}_{dataset}_{time_str}.pth')
